...
export default function Alert({ 
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 max-w-sm w-full p-4 rounded-lg border ${alertStyles[type]} shadow-lg transform transition-all duration-300 ease-in-out`}>
